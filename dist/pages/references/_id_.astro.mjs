...
const $$id = createComponent(async ($$result, $$props, $$slots) => {
  ...
  Astro2.self = $$id;
  Astro2.params;
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "type": "Reference", "section": "references" }, { "default": ($$result2) => renderTemplate`
Fix Tags
` })}`;
}, "C:/Documents/code/GitHub/michael-n-cooper/daf-front/src/pages/references/[id].astro", void 0);

const $$file = "C:/Documents/code/GitHub/michael-n-cooper/daf-front/src/pages/references/[id].astro";
const $$url = "/daf-front/references/[id]";
