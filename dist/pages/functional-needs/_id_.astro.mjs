...
async function getStaticPaths() {
  const section = "functional-needs";
...
const $$file = "C:/Documents/code/GitHub/michael-n-cooper/daf-front/src/pages/functional-needs/[id].astro";
const $$url = "/daf-front/functional-needs/[id]";
