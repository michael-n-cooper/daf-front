...
const $$Index = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "IdLabel", $$IdLabel, { "section": "tags", "title": "Tags" })}`;
}, "C:/Documents/code/GitHub/michael-n-cooper/daf-front/src/pages/tags/index.astro", void 0);

const $$file = "C:/Documents/code/GitHub/michael-n-cooper/daf-front/src/pages/tags/index.astro";
const $$url = "/daf-front/tags";
